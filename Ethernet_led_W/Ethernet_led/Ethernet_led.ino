/*
  Ethernet LED
  Este codigo utiliza una pagina web para encender una serie de leds

  Ultima modificacion 29 de mayo 2017
  Por Daniel Santos
*/
...
byte mac[] = { 0x90, 0xA2, 0xDA, 0xEF, 0xFE, 0xED }; //esto declara la direccion MAC
IPAddress ip(192, 168, 1, 20); // Esta es la direccion IP
EthernetServer server(80); //Este es el puerto

//declaramos variables que usaremos en el programa
